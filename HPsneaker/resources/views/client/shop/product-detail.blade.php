        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item mb-3">
                        <img src="{{ asset($product->thumbnail) }}" alt="{{ $product->name }}" class="img-fluid rounded shadow" style="width:100%;max-height:400px;object-fit:cover;">
                    </div>
                    @if(isset($product->gallery) && count($product->gallery))
                        <div class="product__details__pic">
                            @foreach($product->gallery as $img)
                                <img src="{{ asset($img->url) }}" alt="" class="img-thumbnail" style="width:80px;height:80px;object-fit:cover;">
                            @endforeach
                        </div>
                    @endif
                </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="product__details__price mb-3 h4 text-danger">{{ number_format($product->price ?? 0, 0, ',', '.') }} đ</div>
                    <p class="mb-3">{{ $product->description ?? 'Mô tả sản phẩm sẽ hiển thị ở đây.' }}</p>
                    ...
                    <ul class="mt-3 list-unstyled">
                        <li><b>Tình trạng:</b> <span>{{ ($product->in_stock ?? true) ? 'Còn hàng' : 'Hết hàng' }}</span></li>
            ...
            <div class="col-lg-12 mt-5">
                <div class="product__details__tab">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab" aria-selected="false">Đánh giá <span>({{ $product->reviews_count ?? 0 }})</span></a>
                        </li>
                    </ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                        <div class="product__item h-100 d-flex flex-column">
                            <div class="product__item__pic mb-2">
                                <img src="{{ asset($item->thumbnail) }}" alt="{{ $item->name }}" class="img-fluid rounded" style="height:180px;object-fit:cover;width:100%;">
