                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    <form action="{{ route('product.review.store', $product->id) }}"
                                                        ...
                                                        <button type="submit" class="primary-btn mr-2">Gửi đánh
                                                            giá</button>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="product__details__tab">
                                            ...
                                            <div class="tab-content p-3 border border-top-0 rounded-bottom bg-light">
                                                <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                                    <div class="product__details__tab__desc">
                                                        <h6>Mô tả sản phẩm</h6>
                                                        <p>{{ $product->description ?? 'Mô tả sản phẩm sẽ hiển thị ở đây.' }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tabs-2" role="tabpanel">
                                                ...
                                                <div class="tab-pane" id="tabs-3" role="tabpanel">
                                                    <div class="product__details__tab__desc">
                                                        ...
                                                        @if (session('user'))
                                                            <form
                                                                action="{{ route('product.comment.store', $product->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="form-group">
                                                                ...
                                                                <button type="submit" class="btn btn-dark mt-2">Gửi bình
                                                                    luận</button>
                                                            </form>
                                                        @else
                                                            <p>Vui lòng <a href="{{ route('user.login') }}">đăng nhập</a>
                                                                để bình luận.</p>
                                                        @endif
